...
const APP_SHELL = [
  ...
  `${APP_SCOPE}handwriting-engine.js`, `${APP_SCOPE}pwa.js`,
  `${APP_SCOPE}offline-storage.js`, `${APP_SCOPE}documents.js`,
  `${APP_SCOPE}page-history.js`, `${APP_SCOPE}icons/icon.svg`
];
